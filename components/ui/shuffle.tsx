...
const Shuffle: React.FC<ShuffleProps> = ({
    ...
    useGSAP(
        () => {
            ...
            const build = () => {
                ...
                const chars = (splitRef.current.chars || []) as unknown as HTMLElement[];
                wrappersRef.current = [];
            ...
            const play = () => {
                ...
                const addTween = (targets: HTMLElement[], at: number) => {
                    tl.to(
                        targets,
                        {
                            x: (i: number, t: HTMLElement) => parseFloat(t.getAttribute('data-final-x') || '0'),
                            duration,
                            ease,
                            force3D: true,
    ...
    const Tag = (tag || 'p') as AllowedTags;
